...
public class ModelFix {
    ...
    public static float getShrinkRatio(TextureAtlasSprite atlas, float defaultValue, float returnValue) {
    ...
    public static void createOrExpandSpan(List<ItemModelGenerator.Span> listSpans, ItemModelGenerator.SpanFacing spanFacing,
        ...
        for (ItemModelGenerator.Span span2 : listSpans) {
            if (span2.func_178383_a() == spanFacing) {
                ...
                if (getExpansion() != 0 && span2.func_178384_c() != (!spanFacing.func_178369_d() ? pixelY : pixelX) - 1)
                    continue;
                existingSpan = span2;
                break;
            }
